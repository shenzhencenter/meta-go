...
func GetAdsUserSettingsWithResponse(ctx context.Context, client *core.Client, id string, params GetAdsUserSettingsParams) (*objects.AdsUserSettings, *core.Response, error) {
	var out objects.AdsUserSettings
...
func GetAdsUserSettings(ctx context.Context, client *core.Client, id string, params GetAdsUserSettingsParams) (*objects.AdsUserSettings, error) {
	out, _, err := GetAdsUserSettingsWithResponse(ctx, client, id, params)
	return out, err
}
