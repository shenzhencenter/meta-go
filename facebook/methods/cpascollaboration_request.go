...
func GetCPASCollaborationRequestWithResponse(ctx context.Context, client *core.Client, id string, params GetCPASCollaborationRequestParams) (*objects.CPASCollaborationRequest, *core.Response, error) {
	var out objects.CPASCollaborationRequest
...
func GetCPASCollaborationRequest(ctx context.Context, client *core.Client, id string, params GetCPASCollaborationRequestParams) (*objects.CPASCollaborationRequest, error) {
	out, _, err := GetCPASCollaborationRequestWithResponse(ctx, client, id, params)
	return out, err
}
